...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3"><input class="btn btn-primary" type="submit" value="Submit">
							<a class="btn btn-primary" href="">Get Quotes</a>
							<a class="btn btn-primary" href="">Continue</a></div></div>
					</form>		
				</div>
			</div>
			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<%-- <%  session=request.getSession(false);
							  ArrayList<tshirtDTO> list=(ArrayList<tshirtDTO>)session.getAttribute("aa");
							  if(list!=null){
								  System.out.print(list.size());
								  for(tshirtDTO  var :list){
